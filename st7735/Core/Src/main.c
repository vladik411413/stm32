...
int main(void)
{
  ...
  ADC1->CR2|=1<<20; //EXTTRIG: External trigger conversion mode for regular channels
...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  ADC1->CR1|=1<<5; //EOCIE: This bit is set and cleared by software to enable/disable the End of Conversion interrupt
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim){
	 ...
	 */
	ADC1->CR2|=1 << 22; //SWSTART: Start conversion of regular channels
	//then wait ConvCpltCallback (EOCIE is set in MX_ADC1_Init)
}

void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc){
	//x = ADC1->DR; /* Return ADC converted value */
}
/* USER CODE END 4 */
